package hust.projectair.customize;
...
private TextureRegion background = null;
	...
	public JButton(TextureRegion text) {
		this.text = text;
	}

	public JButton(TextureRegion background, TextureRegion text) {
		this.background = background;
		this.text = text;
	}	
	
	public JButton(TextureRegion background, TextureRegion text, TextureRegion suffix,
				   int margin) {
		this.background = background;
		this.text = text;
		this.suffix = suffix;
